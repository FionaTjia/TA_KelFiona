<div class="form-group {{ $errors->has('id_purchase') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="id_purchase" type="text" id="id_purchase" maxlength="11" required value="{{ isset($purchase->id_purchase) ? $purchase->id_purchase : ''}}" >
...
<div class="form-group {{ $errors->has('jumlah_purchase') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="jumlah_purchase" type="number" id="jumlah_purchase" required value="{{ isset($purchase->jumlah_purchase) ? $purchase->jumlah_purchase : ''}}" >
...
<div class="form-group {{ $errors->has('harga') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="harga" type="number" id="harga" required value="{{ isset($purchase->harga) ? $purchase->harga : ''}}" >
...
<div class="form-group {{ $errors->has('id_produk') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="id_produk" type="text" id="id_produk" maxlength="11" required value="{{ isset($purchase->id_produk) ? $purchase->id_produk : ''}}" >
...
<div class="form-group {{ $errors->has('id_supplier') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="id_supplier" type="text" id="id_supplier" maxlength="11" required value="{{ isset($purchase->id_supplier) ? $purchase->id_supplier : ''}}" >
