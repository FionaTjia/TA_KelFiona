<div class="form-group {{ $errors->has('id_sales') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="id_sales" type="text" id="id_sales" maxlength="11" required value="{{ isset($sale->id_sales) ? $sale->id_sales : ''}}" >
...
<div class="form-group {{ $errors->has('id_produk') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="id_produk" type="text" id="id_produk" maxlength="11" required value="{{ isset($sale->id_produk) ? $sale->id_produk : ''}}" >
...
<div class="form-group {{ $errors->has('id_konsumen') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="id_konsumen" type="text" id="id_konsumen" maxlength="11" required value="{{ isset($sale->id_konsumen) ? $sale->id_konsumen : ''}}" >
...
<div class="form-group {{ $errors->has('jumlah_sales') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="jumlah_sales" type="number" id="jumlah_sales" required value="{{ isset($sale->jumlah_sales) ? $sale->jumlah_sales : ''}}" >
...
<div class="form-group {{ $errors->has('total_harga_sales') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="total_harga_sales" type="number" id="total_harga_sales" required value="{{ isset($sale->total_harga_sales) ? $sale->total_harga_sales : ''}}" >
