<div class="form-group {{ $errors->has('id_sales') ? 'has-error' : ''}}">
    <label for="id_sales" class="control-label">{{ 'Id Sales' }}</label>
...
<div class="form-group {{ $errors->has('jumlah_sales') ? 'has-error' : ''}}">
    <label for="jumlah_sales" class="control-label">{{ 'Jumlah Sales' }}</label>
...
<div class="form-group {{ $errors->has('total_harga_sales') ? 'has-error' : ''}}">
    <label for="total_harga_sales" class="control-label">{{ 'Total Harga Sales' }}</label>
