...
<div class="form-group {{ $errors->has('hargaJual_produk') ? 'has-error' : ''}}">
    <label for="hargaJual_produk" class="control-label">{{ 'Hargajual Produk' }}</label>
...
<div class="form-group {{ $errors->has('modal_produk') ? 'has-error' : ''}}">
    <label for="modal_produk" class="control-label">{{ 'Modal Produk' }}</label>
...
<div class="form-group {{ $errors->has('product_id_category') ? 'has-error' : ''}}">
    <label for="product_id_category" class="control-label">{{ 'Product Id Category' }}</label>
